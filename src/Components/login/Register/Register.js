                ...
                <form onSubmit={handleSubmit} className="px-10  md:py-12 py-9  md:flex items-center justify-center">
                    ...
                    <div className="bg-white shadow-lg rounded xl:w-1/2 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-10 py-6">
                        ...
                        <p tabIndex={0} className="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">
                            ...
                            <Link to='/' className="hover:text-gray-500 focus:text-gray-500 focus:outline-none focus:underline hover:underline text-sm font-medium leading-none text-gray-800 cursor-pointer">
                                {" "}
                                Sign In here
                            </Link>
                        </p>
                        <button onClick={handleGoogleSignIn} aria-label="Continue with google" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-3 border rounded-lg border-gray-700 flex items-center w-full mt-10 hover:bg-gray-100">
                        ...
                        <div className="mt-6 w-full">
                            ...
                            <div className="relative flex items-center justify-center">
                                <input name='password' id="password" type={showpass ? "text" : "password"} className="bg-gray-200 border rounded text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" required />
                        ...
                        <div className="mt-6 w-full">
                            ...
                            <div className="relative flex items-center justify-center">
                                <input name='confirm' id="confirm" type={showpass ? "text" : "password"} className="bg-gray-200 border rounded text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" required />
                                <div onClick={() => setShowPass(!showpass)} className="absolute right-0 mt-2 mr-3 cursor-pointer">
                                    <div id="show">
                                        <svg width={16} height={16} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                    ...
                    <div className="xl:w-1/2 lg:pl-8 md:pl-8 md:w-1/2 w-full mx-auto md:mt-0 mt-6">
                        ...
                        <div className="flex items-center pl-8 mt-10">
                            ...
                            <div className="ml-2">
                                ...
                                <a href="https://www.facebook.com/mdshijanali135/" ><p className="text-sm font-medium leading-none text-gray-600 mt-1 cursor-pointer hover:underline">See profile</p></a>
                            </div>
                        </div>
                    </div>
                </form>
