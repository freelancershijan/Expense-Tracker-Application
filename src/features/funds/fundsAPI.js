...
export const fundsApi = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getUserSingleFundCategoryDataLists: builder.query({
...
export const { useGetUserFundCategoriesQuery, useGetUserRecentFundsTransactionsQuery, useGetUserSingleFundCategoryDataListsQuery } = fundsApi;